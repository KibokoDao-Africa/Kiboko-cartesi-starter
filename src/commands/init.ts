...
export default class Init extends Command {
  ...
  async function setupProject(projectDir: string) {
  ...
  async function cloneAndSetup(targetDir: any, repoUrl: any) {
    const git = simpleGit()
  ...
  async function setupBackendWithCommand(commandTemplate: string) {
    try {
